...
import ProductLinkedList.Product;
import ProductLinkedList.ProductManager;
...
public class TestProductManager {
    ...
    public static void main(String[] args) {
        ...
        productManager.add(new Product(1,1,"a","mau do"));
        productManager.add(new Product(2,2,"b","mau xanh"));
        productManager.add(new Product(3,3,"c","mau vang"));
        printProducts(productManager);

//      Thêm sản phẩm
        System.out.println("Thêm sản phẩm: ");
        productManager.add(new Product(4, 4, "aaaa","mau tim"));
